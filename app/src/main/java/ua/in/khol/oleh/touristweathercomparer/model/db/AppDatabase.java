...
import ua.in.khol.oleh.touristweathercomparer.model.db.dao.LocationDao;
...
@Database(entities = {City.class, Location.class, Forecast.class, Provider.class, Title.class}, version = 1, exportSchema = false)
