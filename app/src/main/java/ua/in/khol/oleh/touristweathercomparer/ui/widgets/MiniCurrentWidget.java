...
public class MiniCurrentWidget extends MaterialCardView {
    ...
    public MiniCurrentWidget(@NonNull Context context) {
        super(context);
        init(context);
    }

    public MiniCurrentWidget(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    private void init(Context context) {
        View view = inflate(context, R.layout.widget_mini_current, this);
    ...
    private void setDescription(Context context, Current current, Locale locale) {
        ...
        int size = context.getResources().getDimensionPixelSize(R.dimen.mini_icon_size);
